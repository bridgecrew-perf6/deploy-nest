...
let CollegeController = CollegeController_1 = class CollegeController {
    constructor(_collegeService) {
        this._collegeService = _collegeService;
        this._logger = new common_1.Logger(CollegeController_1.name);
    }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CollegeController.prototype, "createSchool", null);
CollegeController = CollegeController_1 = __decorate([
    (0, common_1.Controller)(api_constant_1.CONTROLLER_CONSTANTS.COLLEGE),
    (0, swagger_1.ApiTags)(api_constant_1.CONTROLLER_CONSTANTS.COLLEGE),
    __param(0, (0, common_1.Inject)(module_config_1.SERVICE_INTERFACE.ICOLLEGE_SERVICE)),
