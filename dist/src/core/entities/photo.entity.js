...
let PhotoEntity = class PhotoEntity extends base_entity_1.BaseEntityAutoId {
};
__decorate([
    (0, typeorm_1.Column)({ name: 'file_name' }),
    __metadata("design:type", String)
], PhotoEntity.prototype, "fileName", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'post_id' }),
    __metadata("design:type", Number)
], PhotoEntity.prototype, "postId", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'is_deleted' }),
    __metadata("design:type", Boolean)
], PhotoEntity.prototype, "isDeleted", void 0);
